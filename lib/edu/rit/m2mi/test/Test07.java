...
// Unit:    Class edu.rit.m2mi.test.Test07
//
...
/**
 * Class Test07 is a unit test main program for testing M2MI omnihandles,
 * multihandles, and unihandles.
 *
...
public class Test07
	...
	public static void main
		...
		try
			...
			Bar u1 = (Bar) M2MI.getUnihandle (targetA, Bar.class);
			Bar u2 = (Bar) M2MI.getUnihandle (targetB, Bar.class);
			Bar group1 = (Bar) M2MI.getMultihandle (Bar.class);
			((Multihandle) group1).attach (targetA);
			((Multihandle) group1).attach (targetB);

			System.out.println();
			System.out.println ("******** Exporting C and D ********");
			BarImpl2 targetC = new BarImpl2 ("Target object C");
			BarImpl2 targetD = new BarImpl2 ("Target object D");
			M2MI.export (targetC, Bar.class);
			M2MI.export (targetD, Bar.class);
			Bar allBars = (Bar) M2MI.getOmnihandle (Bar.class);

			System.out.println();
			System.out.println ("******** Do calls on Unihandle 1 ********");
			doCalls (u1);

			System.out.println();
			System.out.println ("******** Do calls on Unihandle 2 ********");
			doCalls (u2);
			...
			System.out.println();
			System.out.println ("******** Serializing Unihandle 1 ********");
			...
			System.out.println();
			System.out.println ("******** Serializing Unihandle 2 ********");
			baos = new ByteArrayOutputStream();
			oos = new ObjectOutputStream (baos);
			oos.writeObject (u2);
			oos.close();
			...
			System.out.println();
			System.out.println ("******** Attaching C to Unihandle 1 ********");
			((Unihandle) u1).attach (targetC);
			...
			System.out.println();
			System.out.println ("******** Detaching C from Unihandle 1 ********");
			((Unihandle) u1).detach();
			...
			System.out.println();
			System.out.println ("******** Unexporting B ********");
			...
			{
			System.err.println ("Test07: Uncaught exception");
