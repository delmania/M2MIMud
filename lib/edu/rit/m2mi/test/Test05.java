...
// Unit:    Class edu.rit.m2mi.test.Test05
//
...
/**
 * Class Test05 is a unit test main program for testing M2MI omnihandles.
 *
...
public class Test05
	...
	public static void main
		...
		try
			...
			System.out.println ("******** Exporting target objects A and B ********");
			...
			System.out.println();
			System.out.println ("******** Serializing handle ********");
			baos = new ByteArrayOutputStream();
			oos = new ObjectOutputStream (baos);
			oos.writeObject (allBars);
			oos.close();
			dump (baos);
			...
			Bar allBars2 = (Bar) ois.readObject();
			ois.close();
			doCalls (allBars2);
			...
			{
			System.err.println ("Test05: Uncaught exception");
