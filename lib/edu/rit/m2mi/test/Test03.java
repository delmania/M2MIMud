...
// Unit:    Class edu.rit.m2mi.test.Test03
//
...
/**
 * Class Test03 is a unit test main program for testing class {@link
...
public class Test03
	...
	public static void main
		...
		try
			...
			while ((obj = invocation1.nextTargetObject()) != null)
				{
				invocation1.invoke (obj);
				}
			...
			System.out.println ("Invoking target method");
			while ((obj = invocation2.nextTargetObject()) != null)
				{
				invocation2.invoke (obj);
				}
			System.out.println ("Writing invocation object");
			baos = new ByteArrayOutputStream();
			oos = new ObjectOutputStream (baos);
			...
			System.out.println ("Invoking target method");
			while ((obj = invocation3.nextTargetObject()) != null)
				{
				invocation3.invoke (obj);
				}
			System.out.println ("Writing invocation object");
			baos = new ByteArrayOutputStream();
			oos = new ObjectOutputStream (baos);
			...
			System.out.println ("Invoking target method");
			while ((obj = invocation4.nextTargetObject()) != null)
				{
				invocation4.invoke (obj);
				}
			System.out.println ("Writing invocation object");
			baos = new ByteArrayOutputStream();
			oos = new ObjectOutputStream (baos);
			...
			{
			System.err.println ("Test03: Uncaught exception");
