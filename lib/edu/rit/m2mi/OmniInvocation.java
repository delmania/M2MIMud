//******************************************************************************
//
// File:    OmniInvocation.java
// Package: edu.rit.m2mi
// Unit:    Class edu.rit.m2mi.OmniInvocation
//
...
/**
 * Class OmniInvocation provides an invocation object for an omnihandle
 * invocation in M2MI.
 * <P>
 * <I>Note:</I> Class OmniInvocation is multiple thread safe.
 *
...
// Hidden constants.
	...
	private static final long serialVersionUID = 2363440940386457894L;

// Exported constructors.

	/**
	 * Construct a new omnihandle invocation object. The invocation object's
	...
	/**
	 * Construct a new omnihandle invocation object with the given EOID, method
...
// Exported operations.
	...
	public void readExternal
		...
		if (format != 1)
			...
			throw new InvalidObjectException
				("OmniInvocation: Invalid format code = " + format);
			}
	...
	/**
	 * Process this omnihandle invocation, assuming it was created as a result
	 * of calling a method on an omnihandle. This method goes to the M2MI Layer
	...
	public void processFromHandle()
		{
		M2MI.processFromHandleOmni (this);
		}

	/**
	 * Process this omnihandle invocation, assuming it was created from an
	...
	public void processFromMessage()
		{
		M2MI.processFromMessageOmni (this);
		}

// Hidden operations to be overridden in a subclass.

	/**
	 * Obtain the M2MP message prefix corresponding to this omnihandle
	...
	protected byte[] getMessagePrefix()
		{
		return M2MIMessagePrefix.getMessagePrefix
			(myMethodDescriptor.getTargetInterface());
		}

	/**
	 * Determine the target objects that this omnihandle invocation object will
	...
	protected Iterator getTargetObjects()
		{
		return M2MI.getTargetObjectsOmni
			(myMethodDescriptor.getTargetInterface());
		}
