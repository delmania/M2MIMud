//******************************************************************************
//
// File:    UniInvocation.java
// Package: edu.rit.m2mi
// Unit:    Class edu.rit.m2mi.UniInvocation
//
...
/**
 * Class UniInvocation provides an invocation object for a unihandle invocation
 * in M2MI.
 * <P>
 * <I>Note:</I> Class UniInvocation is multiple thread safe.
 *
...
// Hidden constants.
	...
	private static final long serialVersionUID = -2461108558889367241L;

// Exported constructors.

	/**
	 * Construct a new unihandle invocation object. The invocation object's
	...
	/**
	 * Construct a new unihandle invocation object with the given EOID, method
...
// Exported operations.
	...
	public void readExternal
		...
		if (format != 1)
			...
			throw new InvalidObjectException
				("UniInvocation: Invalid format code = " + format);
			}
	...
	/**
	 * Process this unihandle invocation, assuming it was created as a result of
	 * calling a method on a unihandle. This method goes to the M2MI Layer to
	 * broadcast this invocation in an outgoing M2MI message if necessary, and
	 * to invoke any target objects exported in the M2MI Layer if necessary.
	 *
	...
	public void processFromHandle()
		{
		M2MI.processFromHandleUni (this);
		}

	/**
	 * Process this unihandle invocation, assuming it was created from an
	...
	public void processFromMessage()
		{
		M2MI.processFromMessageUni (this);
		}

// Hidden operations to be overridden in a subclass.

	/**
	 * Obtain the M2MP message prefix corresponding to this unihandle invocation
	 * object. This method goes to the M2MI Layer to determine the appropriate
	 * message prefix.
	 *
	...
	/**
	 * Determine the target objects that this unihandle invocation object will
	...
	protected Iterator getTargetObjects()
		{
		return M2MI.getTargetObjectsUni (myEoid);
		}
