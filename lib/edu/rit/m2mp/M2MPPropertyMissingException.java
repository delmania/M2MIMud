//******************************************************************************
//
// File:    M2MPPropertyMissingException.java
// Package: edu.rit.m2mp
// Unit:    Class edu.rit.m2mp.M2MPPropertyMissingException
//
 ...
 * @version 26-Sep-2003
 */
public class M2MPPropertyMissingException
...
// Exported constructors.
	...
	/**
	 * Construct a new M2MP property missing exception with no detail message
	 * and no chained exception.
	 */
	public M2MPPropertyMissingException()
		{
		super();
		}

	/**
	 * Construct a new M2MP property missing exception with the given detail
