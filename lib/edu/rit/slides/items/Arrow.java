...
// Unit:    Class edu.rit.slides.items.Arrow
//
 ...
 * ends of a {@link LineItem </CODE>LineItem<CODE>}.
 *
...
// Hidden helper classes.
	 ...
	 * arrow. <TT>thePath</TT> draw the arrow in "standard position" -- with its
	 * tip at (0,0), pointing along the positive X axis, for a stroke width of
	 * 1. If <TT>thePath</TT> is null, the arrow is not drawn. <TT>isFilled</TT>
	 * tells whether the interior of the arrow is filled.
	 *
	 * @author  Alan Kaminsky
	 * @version 10-Oct-2003
	 */
